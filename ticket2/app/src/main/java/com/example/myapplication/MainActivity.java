...
public class MainActivity extends AppCompatActivity {
        ...
        showSelectionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (adultRadioButton.isChecked()) {
                    ticket = getResources().getString(R.string.regularticket);
                } else if (childRadioButton.isChecked()) {
                    ticket = getResources().getString(R.string.childticket);
                } else if (studentRadioButton.isChecked()) {
                    ticket = getResources().getString(R.string.studentticket);
                }
    ...
    private void updateResult() {
        // Get selected gender
        String gender = maleRadioButton.isChecked() ? getResources().getString(R.string.male) : getResources().getString(R.string.female);
    ...
    private double calculateTotalPrice(String ticket, int quantity) {
        double price = 0;
        if (ticket.equals(getResources().getString(R.string.regularticket))) {
            price = 500;
        } else if (ticket.equals(getResources().getString(R.string.childticket))) {
            price = 250;
        } else if (ticket.equals(getResources().getString(R.string.studentticket))) {
            price = 400;
        }
